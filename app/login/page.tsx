    ...
    <div className="min-h-screen bg-slate-950 px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.5fr_1fr] items-center">
        <section className="space-y-6 text-slate-100">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <article className="rounded-[2rem] border border-slate-800/70 bg-slate-900/70 p-6">
              <h2 className="text-sm font-semibold uppercase tracking-[0.2em] text-emerald-300">Para empresas</h2>
        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-slate-950/40 backdrop-blur-xl">
          <div className="mb-6">
            <p className="text-sm uppercase tracking-[0.3em] text-emerald-300">Inicio de sesión</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full rounded-3xl bg-emerald-500 px-5 py-3 text-base font-semibold text-slate-950 transition hover:bg-emerald-400"
            >
              Entrar
            </button>
          </form>
